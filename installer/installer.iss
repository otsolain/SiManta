; ================================================================
;  SiManta - Professional Classroom Management
...
;  - Teacher IP configuration (student only)
;  - Firewall rules
...
; Wizard images (uncomment when BMP files are available)
...
[Icons]
; Teacher shortcuts
Name: "{group}\SiManta - Teacher Console"; Filename: "{app}\Teacher\SiMantaTeacher.exe"; Check: IsTeacherInstall; Comment: "Launch Teacher Console"; IconFilename: "{app}\logo.png"
...
; Student shortcuts (minimal - agent runs silently)
...
[Run]
; Launch Teacher Console after install
...
; Launch Student Agent after install
...
; ================================================================
;  Pascal Script - Custom Radio Button Page
; ================================================================
